...
Files | Description
----- | -----------
[0-simply_match_holberton.rb](./0-simply_match_holberton.rb) |  Ruby script that accepts one argument and pass it to a regular expression matching method that has to match 'School'
